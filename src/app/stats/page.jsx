    ...
    <div className="space-y-6">
      ...
      {interaction.length === 0 ? (
        <div className="p-10 bg-base-100 rounded-xl">
          <h1 className="text-xl font-medium text-[#64748B]">
            No interactions yet. Start calling, texting, or video chatting with
            your friends to see analytics here!
          </h1>
        </div>
      ) : (
        <div className="p-10 bg-base-100 rounded-xl">
          <h1 className="text-xl font-medium text-[#244D3F]">
            By Interaction Type
          </h1>
