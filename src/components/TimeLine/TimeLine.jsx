  ...
  return (
    <div className="p-4 bg-base-100 rounded-lg border border-[#E9E9E9]">
      <div className="flex items-center gap-4">
        <div>
          {item.type === "Call" && (
            <Image src="/imgs/call.png" alt="call" width={40} height={40} />
          )}
          {item.type === "SMS" && (
            <Image src="/imgs/text.png" alt="text" width={40} height={40} />
          )}
          {item.type === "Video Call" && (
            <Image src="/imgs/video.png" alt="video" width={40} height={40} />
          )}
        </div>
